...
namespace IDM.Application.Features.Commerce
{
    public class CommerceContact
    {
        ...
        {
            get => Contact.GetStringValue(IDMConstants.Fields.UserRole);
            set => Contact[IDMConstants.Fields.UserRole] = value;
        }
        ...
        {
            get => Contact.GetStringValue(IDMConstants.Fields.UserLocation);
            set => Contact[IDMConstants.Fields.UserLocation] = value;
        }
