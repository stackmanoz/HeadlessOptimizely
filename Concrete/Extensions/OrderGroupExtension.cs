...
namespace IDM.Shared.Extensions
{
    public static class OrderGroupExtension
    {
        ...
        public static int GetParentOrderId(this OrderGroup orderGroup) => orderGroup.GetIntegerValue(IDMConstants.Quote.ParentOrderGroupId);
        ...
        public static int GetParentOrderId(this ICart orderGroup) => orderGroup.GetIntegerValue(IDMConstants.Quote.ParentOrderGroupId);
